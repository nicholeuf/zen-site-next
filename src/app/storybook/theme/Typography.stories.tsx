...
// MUI components are implemented with React.forwardRef; that causes Storybook's
// docs/source extractor to show <React.ForwardRef> instead of <Typography> in
// the autogenerated code preview. Setting displayName makes the preview
// render the expected component name.
