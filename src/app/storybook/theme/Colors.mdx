...
export const ThemeColorPalette = () => {
  ...
  const paletteItems = [
    ...
    { title: 'text.secondary', subtitle: '?', colors: { secondary: theme.palette.text.secondary } },
    // project constants
    { title: 'constants.guava', subtitle: constants.colors.guava, colors: { guava: constants.colors.guava } },
    { title: 'constants.carob', subtitle: constants.colors.carob, colors: { carob: constants.colors.carob } },
    { title: 'constants.cream', subtitle: constants.colors.cream, colors: { cream: constants.colors.cream } },
    { title: 'constants.gunmetal', subtitle: constants.colors.gunmetal, colors: { gunmetal: constants.colors.gunmetal } },
  ];
  ...
  return (
    <ColorPalette>
      {paletteItems.map((p) => (
        <ColorItem key={p.title} title={p.title} colors={p.colors} />
      ))}
    </ColorPalette>
  );
};
